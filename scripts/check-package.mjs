...
try {
  ...
  await writeFile(join(temporaryDirectory, 'smoke.mjs'), [
    ...
    "import { parseWeekExpression, timetableToIcs } from '@nbtca/nbtcal/timetable';",
  ...
  await writeFile(join(temporaryDirectory, 'consumer.ts'), [
    ...
    "import type { Timetable, TimetableUntimedCourse } from '@nbtca/nbtcal/timetable';",
    "const course: TimetableUntimedCourse = { sourceId: null, courseName: '实践课', teacherNames: [], campus: null, location: null, weeks: [1], kind: 'practice' };",
